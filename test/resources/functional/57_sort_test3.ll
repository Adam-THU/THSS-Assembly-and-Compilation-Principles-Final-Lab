...
mainEntry:
  ...
  %__tmp10 = load i32, i32* %i, align 4
  %__tmp11 = load i32, i32* %tmp, align 4
  %__tmp12 = call i32 @QuickSort([10 x i32]* %a, i32 %__tmp10, i32 %__tmp11)
...
bb1:
  ...
  store i32 %__tmp19, i32* %tmp.1, align 4
  %__tmp20 = load i32, i32* %tmp.1, align 4

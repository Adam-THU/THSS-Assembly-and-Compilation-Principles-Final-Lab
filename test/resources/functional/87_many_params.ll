...
param16Entry:
  ...
  %__tmp33 = call i32 @sort(i32* %__tmp32, i32 16)
  %__tmp34 = getelementptr inbounds [16 x i32], [16 x i32]* %arr, i64 0, i64 0
  %__tmp35 = load i32, i32* %__tmp34, align 4
  %__tmp36 = getelementptr inbounds [16 x i32], [16 x i32]* %arr, i64 0, i64 1
  %__tmp37 = load i32, i32* %__tmp36, align 4
  %__tmp38 = getelementptr inbounds [16 x i32], [16 x i32]* %arr, i64 0, i64 2
  %__tmp39 = load i32, i32* %__tmp38, align 4
  %__tmp40 = getelementptr inbounds [16 x i32], [16 x i32]* %arr, i64 0, i64 3
  %__tmp41 = load i32, i32* %__tmp40, align 4
  %__tmp42 = getelementptr inbounds [16 x i32], [16 x i32]* %arr, i64 0, i64 4
  %__tmp43 = load i32, i32* %__tmp42, align 4
  %__tmp44 = getelementptr inbounds [16 x i32], [16 x i32]* %arr, i64 0, i64 5
  %__tmp45 = load i32, i32* %__tmp44, align 4
  %__tmp46 = getelementptr inbounds [16 x i32], [16 x i32]* %arr, i64 0, i64 6
  %__tmp47 = load i32, i32* %__tmp46, align 4
  %__tmp48 = getelementptr inbounds [16 x i32], [16 x i32]* %arr, i64 0, i64 7
  %__tmp49 = load i32, i32* %__tmp48, align 4
  %__tmp50 = getelementptr inbounds [16 x i32], [16 x i32]* %arr, i64 0, i64 8
  %__tmp51 = load i32, i32* %__tmp50, align 4
  %__tmp52 = getelementptr inbounds [16 x i32], [16 x i32]* %arr, i64 0, i64 9
  %__tmp53 = load i32, i32* %__tmp52, align 4
  %__tmp54 = getelementptr inbounds [16 x i32], [16 x i32]* %arr, i64 0, i64 10
  %__tmp55 = load i32, i32* %__tmp54, align 4
  %__tmp56 = getelementptr inbounds [16 x i32], [16 x i32]* %arr, i64 0, i64 11
  %__tmp57 = load i32, i32* %__tmp56, align 4
  %__tmp58 = getelementptr inbounds [16 x i32], [16 x i32]* %arr, i64 0, i64 12
  %__tmp59 = load i32, i32* %__tmp58, align 4
  %__tmp60 = getelementptr inbounds [16 x i32], [16 x i32]* %arr, i64 0, i64 13
  %__tmp61 = load i32, i32* %__tmp60, align 4
  %__tmp62 = getelementptr inbounds [16 x i32], [16 x i32]* %arr, i64 0, i64 14
  %__tmp63 = load i32, i32* %__tmp62, align 4
  %__tmp64 = getelementptr inbounds [16 x i32], [16 x i32]* %arr, i64 0, i64 15
  %__tmp65 = load i32, i32* %__tmp64, align 4
  %__tmp66 = load i32, i32* %a1_arg, align 4
  %__tmp67 = load i32, i32* %a2_arg, align 4
  %__tmp68 = load i32, i32* %a3_arg, align 4
  %__tmp69 = load i32, i32* %a4_arg, align 4
  %__tmp70 = load i32, i32* %a5_arg, align 4
  %__tmp71 = load i32, i32* %a6_arg, align 4
  %__tmp72 = load i32, i32* %a7_arg, align 4
  %__tmp73 = load i32, i32* %a8_arg, align 4
  %__tmp74 = load i32, i32* %a9_arg, align 4
  %__tmp75 = load i32, i32* %a10_arg, align 4
  %__tmp76 = load i32, i32* %a11_arg, align 4
  %__tmp77 = load i32, i32* %a12_arg, align 4
  %__tmp78 = load i32, i32* %a13_arg, align 4
  %__tmp79 = load i32, i32* %a14_arg, align 4
  %__tmp80 = load i32, i32* %a15_arg, align 4
  %__tmp81 = load i32, i32* %a16_arg, align 4
  %__tmp82 = call i32 @param32_rec(i32 %__tmp35, i32 %__tmp37, i32 %__tmp39, i32 %__tmp41, i32 %__tmp43, i32 %__tmp45, i32 %__tmp47, i32 %__tmp49, i32 %__tmp51, i32 %__tmp53, i32 %__tmp55, i32 %__tmp57, i32 %__tmp59, i32 %__tmp61, i32 %__tmp63, i32 %__tmp65, i32 %__tmp66, i32 %__tmp67, i32 %__tmp68, i32 %__tmp69, i32 %__tmp70, i32 %__tmp71, i32 %__tmp72, i32 %__tmp73, i32 %__tmp74, i32 %__tmp75, i32 %__tmp76, i32 %__tmp77, i32 %__tmp78, i32 %__tmp79, i32 %__tmp80, i32 %__tmp81)
  ret i32 %__tmp82
}

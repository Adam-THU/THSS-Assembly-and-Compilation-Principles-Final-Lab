...
mainEntry:
  ...
  %__tmp0 = getelementptr inbounds [4 x [1024 x i32]], [4 x [1024 x i32]]* %b, i64 0, i64 1
  %__tmp1 = getelementptr inbounds [1024 x i32], [1024 x i32]* %__tmp0, i64 0, i64 0
  store i32 1, i32* %__tmp1, align 4
  %__tmp2 = getelementptr inbounds [4 x [1024 x i32]], [4 x [1024 x i32]]* %b, i64 0, i64 2
  %__tmp3 = getelementptr inbounds [1024 x i32], [1024 x i32]* %__tmp2, i64 0, i64 0
  store i32 2, i32* %__tmp3, align 4
  %__tmp4 = getelementptr inbounds [4 x [1024 x i32]], [4 x [1024 x i32]]* %b, i64 0, i64 2
  %__tmp5 = getelementptr inbounds [1024 x i32], [1024 x i32]* %__tmp4, i64 0, i64 1
  store i32 3, i32* %__tmp5, align 4
  %__tmp6 = getelementptr inbounds [4 x [1024 x i32]], [4 x [1024 x i32]]* %b, i64 0, i64 3
  %__tmp7 = getelementptr inbounds [1024 x i32], [1024 x i32]* %__tmp6, i64 0, i64 0
  store i32 4, i32* %__tmp7, align 4
  %__tmp8 = getelementptr inbounds [4 x [1024 x i32]], [4 x [1024 x i32]]* %b, i64 0, i64 3
  %__tmp9 = getelementptr inbounds [1024 x i32], [1024 x i32]* %__tmp8, i64 0, i64 1
  store i32 5, i32* %__tmp9, align 4
  %__tmp10 = getelementptr inbounds [4 x [1024 x i32]], [4 x [1024 x i32]]* %b, i64 0, i64 3
  %__tmp11 = getelementptr inbounds [1024 x i32], [1024 x i32]* %__tmp10, i64 0, i64 2
  ...
  %__tmp16 = getelementptr inbounds [1024 x [4 x i32]], [1024 x [4 x i32]]* %c, i64 0, i64 1
  %__tmp17 = getelementptr inbounds [4 x i32], [4 x i32]* %__tmp16, i64 0, i64 0
  store i32 3, i32* %__tmp17, align 4
  %__tmp18 = getelementptr inbounds [1024 x [4 x i32]], [1024 x [4 x i32]]* %c, i64 0, i64 1
  ...
  %__tmp21 = getelementptr inbounds [4 x i32], [4 x i32]* %__tmp20, i64 0, i64 0
  %__tmp22 = call i32 @f1(i32* %__tmp21)
  call void @putint(i32 %__tmp22)
  call void @putch(i32 10)
  %__tmp23 = getelementptr inbounds [1024 x [4 x i32]], [1024 x [4 x i32]]* %c, i64 0, i64 2
  %__tmp24 = getelementptr inbounds [4 x i32], [4 x i32]* %__tmp23, i64 0, i64 0

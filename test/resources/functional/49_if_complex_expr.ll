...
bb0:
  ...
  %__tmp15 = call i32 @putint(i32 %__tmp14)
  br label %bb2
bb1:
  br label %bb2
bb2:
  %__tmp16 = load i32, i32* %d, align 4
  %__tmp17 = srem i32 %__tmp16, 2
  %__tmp18 = add i32 %__tmp17, 67
  %__tmp19 = icmp slt i32 %__tmp18, 0
  br i1 %__tmp19, label %bb14, label %bb12
bb14:
  br label %bb13
bb12:
  %__tmp20 = load i32, i32* %a, align 4
  %__tmp21 = load i32, i32* %b, align 4
  %__tmp22 = sub i32 %__tmp20, %__tmp21
  %__tmp23 = icmp ne i32 %__tmp22, 0
  br i1 %__tmp23, label %bb15, label %bb17
bb17:
  br label %bb16
bb15:
  %__tmp24 = load i32, i32* %c, align 4
  %__tmp25 = add i32 %__tmp24, 2
  %__tmp26 = srem i32 %__tmp25, 2
  %__tmp27 = icmp ne i32 %__tmp26, 0
  br label %bb16
bb16:
  %__tmp28 = phi i1 [ 0, %bb17 ], [ %__tmp27, %bb15 ]
  br label %bb13
bb13:
  %__tmp29 = phi i1 [ 1, %bb14 ], [ %__tmp28, %bb16 ]
  br i1 %__tmp29, label %bb9, label %bb10
bb9:
  store i32 4, i32* %result, align 4
  %__tmp30 = load i32, i32* %result, align 4
  %__tmp31 = call i32 @putint(i32 %__tmp30)
  br label %bb11
bb10:
  br label %bb11
bb11:

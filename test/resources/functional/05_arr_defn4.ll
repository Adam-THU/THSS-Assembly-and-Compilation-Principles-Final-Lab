...
mainEntry:
  ...
  store i32 3, i32* %__tmp45, align 4
  %__tmp46 = getelementptr inbounds [4 x [2 x [1 x i32]]], [4 x [2 x [1 x i32]]]* %e, i64 0, i64 1
  %__tmp47 = getelementptr inbounds [2 x [1 x i32]], [2 x [1 x i32]]* %__tmp46, i64 0, i64 1
  %__tmp48 = getelementptr inbounds [1 x i32], [1 x i32]* %__tmp47, i64 0, i64 0
  store i32 4, i32* %__tmp48, align 4
  %__tmp49 = getelementptr inbounds [4 x [2 x [1 x i32]]], [4 x [2 x [1 x i32]]]* %e, i64 0, i64 2
  %__tmp50 = getelementptr inbounds [2 x [1 x i32]], [2 x [1 x i32]]* %__tmp49, i64 0, i64 0
  %__tmp51 = getelementptr inbounds [1 x i32], [1 x i32]* %__tmp50, i64 0, i64 0
  store i32 5, i32* %__tmp51, align 4
  %__tmp52 = getelementptr inbounds [4 x [2 x [1 x i32]]], [4 x [2 x [1 x i32]]]* %e, i64 0, i64 2
  %__tmp53 = getelementptr inbounds [2 x [1 x i32]], [2 x [1 x i32]]* %__tmp52, i64 0, i64 1
  %__tmp54 = getelementptr inbounds [1 x i32], [1 x i32]* %__tmp53, i64 0, i64 0
  store i32 6, i32* %__tmp54, align 4
  %__tmp55 = getelementptr inbounds [4 x [2 x [1 x i32]]], [4 x [2 x [1 x i32]]]* %e, i64 0, i64 3
  %__tmp56 = getelementptr inbounds [2 x [1 x i32]], [2 x [1 x i32]]* %__tmp55, i64 0, i64 0
  %__tmp57 = getelementptr inbounds [1 x i32], [1 x i32]* %__tmp56, i64 0, i64 0
  store i32 7, i32* %__tmp57, align 4
  %__tmp58 = getelementptr inbounds [4 x [2 x [1 x i32]]], [4 x [2 x [1 x i32]]]* %e, i64 0, i64 3
  %__tmp59 = getelementptr inbounds [2 x [1 x i32]], [2 x [1 x i32]]* %__tmp58, i64 0, i64 1
  %__tmp60 = getelementptr inbounds [1 x i32], [1 x i32]* %__tmp59, i64 0, i64 0
  store i32 8, i32* %__tmp60, align 4
  %__tmp61 = getelementptr inbounds [4 x [2 x [1 x i32]]], [4 x [2 x [1 x i32]]]* %e, i64 0, i64 3
  %__tmp62 = getelementptr inbounds [2 x [1 x i32]], [2 x [1 x i32]]* %__tmp61, i64 0, i64 1
  %__tmp63 = getelementptr inbounds [1 x i32], [1 x i32]* %__tmp62, i64 0, i64 0
  %__tmp64 = load i32, i32* %__tmp63, align 4
  %__tmp65 = getelementptr inbounds [4 x [2 x [1 x i32]]], [4 x [2 x [1 x i32]]]* %e, i64 0, i64 0
  %__tmp66 = getelementptr inbounds [2 x [1 x i32]], [2 x [1 x i32]]* %__tmp65, i64 0, i64 0
  %__tmp67 = getelementptr inbounds [1 x i32], [1 x i32]* %__tmp66, i64 0, i64 0
  %__tmp68 = load i32, i32* %__tmp67, align 4
  %__tmp69 = add i32 %__tmp64, %__tmp68
  %__tmp70 = getelementptr inbounds [4 x [2 x [1 x i32]]], [4 x [2 x [1 x i32]]]* %e, i64 0, i64 0
  %__tmp71 = getelementptr inbounds [2 x [1 x i32]], [2 x [1 x i32]]* %__tmp70, i64 0, i64 1
  %__tmp72 = getelementptr inbounds [1 x i32], [1 x i32]* %__tmp71, i64 0, i64 0
  %__tmp73 = load i32, i32* %__tmp72, align 4
  %__tmp74 = add i32 %__tmp69, %__tmp73
  %__tmp75 = getelementptr inbounds [4 x [2 x i32]], [4 x [2 x i32]]* %d, i64 0, i64 3
  %__tmp76 = getelementptr inbounds [2 x i32], [2 x i32]* %__tmp75, i64 0, i64 0
